...
from . import tensor_shape_pb2 as proto_dot_tensor__shape__pb2
from . import types_pb2 as proto_dot_types__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='proto/tensor.proto',
  package='tensorboard_easy',
  syntax='proto3',
  serialized_pb=_b('\n\x12proto/tensor.proto\x12\x10tensorboard_easy\x1a\x18proto/tensor_shape.proto\x1a\x11proto/types.proto\"\xd9\x02\n\x0bTensorProto\x12)\n\x05\x64type\x18\x01 \x01(\x0e\x32\x1a.tensorboard_easy.DataType\x12\x38\n\x0ctensor_shape\x18\x02 \x01(\x0b\x32\".tensorboard_easy.TensorShapeProto\x12\x16\n\x0eversion_number\x18\x03 \x01(\x05\x12\x14\n\x08half_val\x18\r \x03(\x05\x42\x02\x10\x01\x12\x15\n\tfloat_val\x18\x05 \x03(\x02\x42\x02\x10\x01\x12\x16\n\ndouble_val\x18\x06 \x03(\x01\x42\x02\x10\x01\x12\x13\n\x07int_val\x18\x07 \x03(\x05\x42\x02\x10\x01\x12\x12\n\nstring_val\x18\x08 \x03(\x0c\x12\x18\n\x0cscomplex_val\x18\t \x03(\x02\x42\x02\x10\x01\x12\x15\n\tint64_val\x18\n \x03(\x03\x42\x02\x10\x01\x12\x14\n\x08\x62ool_val\x18\x0b \x03(\x08\x42\x02\x10\x01\x12\x18\n\x0c\x64\x63omplex_val\x18\x0c \x03(\x01\x42\x02\x10\x01\x42\x03\xf8\x01\x01\x62\x06proto3')
  ,
  dependencies=[proto_dot_tensor__shape__pb2.DESCRIPTOR,proto_dot_types__pb2.DESCRIPTOR,])
...
_TENSORPROTO = _descriptor.Descriptor(
  name='TensorProto',
  full_name='tensorboard_easy.TensorProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='dtype', full_name='tensorboard_easy.TensorProto.dtype', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tensor_shape', full_name='tensorboard_easy.TensorProto.tensor_shape', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='version_number', full_name='tensorboard_easy.TensorProto.version_number', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='half_val', full_name='tensorboard_easy.TensorProto.half_val', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='float_val', full_name='tensorboard_easy.TensorProto.float_val', index=4,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))),
    _descriptor.FieldDescriptor(
      name='double_val', full_name='tensorboard_easy.TensorProto.double_val', index=5,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))),
    _descriptor.FieldDescriptor(
      name='int_val', full_name='tensorboard_easy.TensorProto.int_val', index=6,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))),
    _descriptor.FieldDescriptor(
      name='string_val', full_name='tensorboard_easy.TensorProto.string_val', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='scomplex_val', full_name='tensorboard_easy.TensorProto.scomplex_val', index=8,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))),
    _descriptor.FieldDescriptor(
      name='int64_val', full_name='tensorboard_easy.TensorProto.int64_val', index=9,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))),
    _descriptor.FieldDescriptor(
      name='bool_val', full_name='tensorboard_easy.TensorProto.bool_val', index=10,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))),
    _descriptor.FieldDescriptor(
      name='dcomplex_val', full_name='tensorboard_easy.TensorProto.dcomplex_val', index=11,
...
_TENSORPROTO.fields_by_name['dtype'].enum_type = proto_dot_types__pb2._DATATYPE
_TENSORPROTO.fields_by_name['tensor_shape'].message_type = proto_dot_tensor__shape__pb2._TENSORSHAPEPROTO
...
TensorProto = _reflection.GeneratedProtocolMessageType('TensorProto', (_message.Message,), dict(
  ...
  __module__ = 'proto.tensor_pb2'
  # @@protoc_insertion_point(class_scope:tensorboard_easy.TensorProto)
  ))
